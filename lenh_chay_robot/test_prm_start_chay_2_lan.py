...
def main():
    ...
    # Cấu hình chuyển động mượt và dùng thuật toán PRM
    group.set_goal_joint_tolerance(0.01)
    group.set_max_velocity_scaling_factor(0.2)
    group.set_max_acceleration_scaling_factor(0.2)
    group.set_planning_time(5.0)
    group.set_planner_id("PRMkConfigDefault")  # Sử dụng thuật toán PRM
    ...
    for i in range(2):
        ...
        for idx, pose in enumerate(sequence):
            ...
            plan = group.plan()
            if plan and plan[0]:
                rospy.loginfo(f"➡️ Di chuyển đến điểm {idx+1} bằng PRM")
    ...
    rospy.loginfo("✅ Hoàn tất 2 vòng chuyển động bằng PRM.")
