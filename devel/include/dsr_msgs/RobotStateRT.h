...
struct Printer< ::dsr_msgs::RobotStateRT_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dsr_msgs::RobotStateRT_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_joint_position: ";
    if (v.actual_joint_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_joint_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_joint_position[i]);
    }
    if (v.actual_joint_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_joint_position_abs: ";
    if (v.actual_joint_position_abs.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_joint_position_abs.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_joint_position_abs[i]);
    }
    if (v.actual_joint_position_abs.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_joint_velocity: ";
    if (v.actual_joint_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_joint_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_joint_velocity[i]);
    }
    if (v.actual_joint_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_joint_velocity_abs: ";
    if (v.actual_joint_velocity_abs.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_joint_velocity_abs.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_joint_velocity_abs[i]);
    }
    if (v.actual_joint_velocity_abs.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_tcp_position: ";
    if (v.actual_tcp_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_tcp_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_tcp_position[i]);
    }
    if (v.actual_tcp_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_tcp_velocity: ";
    if (v.actual_tcp_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_tcp_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_tcp_velocity[i]);
    }
    if (v.actual_tcp_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_flange_position: ";
    if (v.actual_flange_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_flange_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_flange_position[i]);
    }
    if (v.actual_flange_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_flange_velocity: ";
    if (v.actual_flange_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_flange_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_flange_velocity[i]);
    }
    if (v.actual_flange_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_motor_torque: ";
    if (v.actual_motor_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_motor_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_motor_torque[i]);
    }
    if (v.actual_motor_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_joint_torque: ";
    if (v.actual_joint_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_joint_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_joint_torque[i]);
    }
    if (v.actual_joint_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "raw_joint_torque: ";
    if (v.raw_joint_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.raw_joint_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.raw_joint_torque[i]);
    }
    if (v.raw_joint_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "raw_force_torque: ";
    if (v.raw_force_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.raw_force_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.raw_force_torque[i]);
    }
    if (v.raw_force_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "external_joint_torque: ";
    if (v.external_joint_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.external_joint_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.external_joint_torque[i]);
    }
    if (v.external_joint_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "external_tcp_force: ";
    if (v.external_tcp_force.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.external_tcp_force.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.external_tcp_force[i]);
    }
    if (v.external_tcp_force.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_joint_position: ";
    if (v.target_joint_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_joint_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_joint_position[i]);
    }
    if (v.target_joint_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_joint_velocity: ";
    if (v.target_joint_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_joint_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_joint_velocity[i]);
    }
    if (v.target_joint_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_joint_acceleration: ";
    if (v.target_joint_acceleration.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_joint_acceleration.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_joint_acceleration[i]);
    }
    if (v.target_joint_acceleration.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_motor_torque: ";
    if (v.target_motor_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_motor_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_motor_torque[i]);
    }
    if (v.target_motor_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_tcp_position: ";
    if (v.target_tcp_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_tcp_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_tcp_position[i]);
    }
    if (v.target_tcp_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_tcp_velocity: ";
    if (v.target_tcp_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_tcp_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.target_tcp_velocity[i]);
    }
    if (v.target_tcp_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "jacobian_matrix: ";
    if (v.jacobian_matrix.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.jacobian_matrix.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::std_msgs::Float64MultiArray_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.jacobian_matrix[i]);
    }
    if (v.jacobian_matrix.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "gravity_torque: ";
    if (v.gravity_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.gravity_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.gravity_torque[i]);
    }
    if (v.gravity_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "coriolis_matrix: ";
    if (v.coriolis_matrix.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.coriolis_matrix.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::std_msgs::Float64MultiArray_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.coriolis_matrix[i]);
    }
    if (v.coriolis_matrix.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.mass_matrix.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::std_msgs::Float64MultiArray_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.mass_matrix[i]);
    }
    if (v.mass_matrix.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.joint_temperature.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.joint_temperature[i]);
    }
    if (v.joint_temperature.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "controller_analog_input_type: ";
    if (v.controller_analog_input_type.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.controller_analog_input_type.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.controller_analog_input_type[i]);
    }
    if (v.controller_analog_input_type.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "controller_analog_input: ";
    if (v.controller_analog_input.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.controller_analog_input.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.controller_analog_input[i]);
    }
    if (v.controller_analog_input.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "controller_analog_output_type: ";
    if (v.controller_analog_output_type.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.controller_analog_output_type.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.controller_analog_output_type[i]);
    }
    if (v.controller_analog_output_type.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "controller_analog_output: ";
    if (v.controller_analog_output.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.controller_analog_output.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.controller_analog_output[i]);
    }
    if (v.controller_analog_output.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "flange_analog_input: ";
    if (v.flange_analog_input.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.flange_analog_input.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.flange_analog_input[i]);
    }
    if (v.flange_analog_input.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "external_encoder_strobe_count: ";
    if (v.external_encoder_strobe_count.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.external_encoder_strobe_count.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.external_encoder_strobe_count[i]);
    }
    if (v.external_encoder_strobe_count.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "external_encoder_count: ";
    if (v.external_encoder_count.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.external_encoder_count.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint16_t>::stream(s, true ? std::string() : indent + "    ", v.external_encoder_count[i]);
    }
    if (v.external_encoder_count.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "goal_joint_position: ";
    if (v.goal_joint_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.goal_joint_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.goal_joint_position[i]);
    }
    if (v.goal_joint_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "goal_tcp_position: ";
    if (v.goal_tcp_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.goal_tcp_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.goal_tcp_position[i]);
    }
    if (v.goal_tcp_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.reserved.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.reserved[i]);
    }
    if (v.reserved.empty() || true)
      s << "]";
  }
